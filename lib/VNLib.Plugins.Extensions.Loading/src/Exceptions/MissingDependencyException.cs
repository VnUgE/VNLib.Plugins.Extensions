...
{
    /// <summary>
    /// The exception that is thrown when a required dependency is missing.
    /// </summary>
    public sealed class MissingDependencyException : Exception
    {
        ...
        { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MissingDependencyException"/> class with a specified error message and a reference to the inner exception.
        /// </summary>
        /// <param name="message">The error message that describes the exception.</param>
